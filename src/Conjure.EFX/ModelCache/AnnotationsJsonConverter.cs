...
namespace Conjure.EFX.ModelCache
{
    public class AnnotationsJsonConverter : JsonConverter<IEnumerable<Annotation>>
    {
        ...
        public override void WriteJson(JsonWriter writer, IEnumerable<Annotation> value, JsonSerializer serializer)
        {
        ...
        public override IEnumerable<Annotation> ReadJson(JsonReader reader, Type objectType, IEnumerable<Annotation> existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
