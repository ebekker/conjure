...
namespace Conjure.EFX.ModelCache
{
    public class KeyValueTuplesJsonConverter : JsonConverter<IEnumerable<(string, object)>>
    {
        ...
        public override void WriteJson(JsonWriter writer, IEnumerable<(string, object)> value, JsonSerializer serializer)
        {
        ...
        public override IEnumerable<(string, object)> ReadJson(JsonReader reader, Type objectType, IEnumerable<(string, object)> existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
